...
export default function JobsPage() {
  ...
  const filteredJobs = allJobs.filter((job) => {
    ...
    const matchesCategory =
      ...
      (selectedCategory === "very-high" && job.matchLevel === "Very High") ||
      (selectedCategory === "high" && job.matchLevel === "High") ||
      (selectedCategory === "medium" && job.matchLevel === "Medium")

    // Filter by active tag filters
    const matchesTags = activeFilters.length === 0 || activeFilters.some((filter) => job.tags.includes(filter))
