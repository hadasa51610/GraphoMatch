        ...
        <section className="container mx-auto px-4 mb-32">
          <div className="max-w-6xl mx-auto">
            ...
            <motion.h1
              ...
              className="text-4xl sm:text-5xl md:text-7xl font-bold text-center leading-tight mb-6"
            >
            ...
            <motion.p
              ...
              className="text-lg sm:text-xl text-gray-300 max-w-3xl mx-auto text-center mb-10"
            >
            ...
            >
              <Button
                size="lg"
                className="bg-gradient-to-r from-purple-500 to-pink-600 hover:from-purple-600 hover:to-pink-700 text-white border-0 h-14 px-8 rounded-full group sm:w-auto"
              ...
              <Button
                size="lg"
                variant="outline"
                className="text-black border-white/20 bg-white/5 hover:bg-white/10 h-14 px-8 rounded-full backdrop-blur-sm sm:w-auto"
          ...
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <p className="text-lg sm:text-xl text-gray-300 max-w-2xl mx-auto">
                Our unique approach to job matching combines handwriting analysis with your resume
              </p>
            </motion.div>
                  ...
                  <div className="relative h-full rounded-2xl p-6 bg-gradient-to-br from-gray-900 to-black border border-white/10 backdrop-blur-xl overflow-hidden group-hover:border-white/20 transition-all">
                    ...
                    <div className="relative">
                      ...
                      <p className="text-gray-300 mb-6">
                        Submit your resume and a handwriting sample to our secure platform
                      </p>
                ...
                <div className="relative h-full">
                  ...
                  <div className="relative h-full rounded-2xl p-6 bg-gradient-to-br from-gray-900 to-black border border-white/10 backdrop-blur-xl overflow-hidden group-hover:border-white/20 transition-all">
                    ...
                    <div className="relative">
                      ...
                      <p className="text-gray-300 mb-6">
                        Our AI analyzes your handwriting to identify personality traits and career aptitudes
                      </p>
                      <div className="mt-auto pt-4">
                        <a
                          href="#"
                ...
                <div className="relative h-full">
                  ...
                  <div className="relative h-full rounded-2xl p-6 bg-gradient-to-br from-gray-900 to-black border border-white/10 backdrop-blur-xl overflow-hidden group-hover:border-white/20 transition-all">
                    ...
                    <div className="relative">
                      ...
                      <p className="text-gray-300 mb-6">
                        Receive personalized job recommendations based on your unique profile
                      </p>
                      <div className="mt-auto pt-4">
                        <a
                          href="#"
              ...
              <div className="relative rounded-2xl p-8 md:p-12 bg-gradient-to-br from-gray-900 to-black border border-white/10 backdrop-blur-xl overflow-hidden">
                ...
                <div className="relative flex flex-col md:flex-row items-center gap-8 md:gap-12">
                  <div className="md:w-1/2">
                    ...
                    <Button
                      size="lg"
                      className="bg-gradient-to-r from-purple-500 to-pink-600 hover:from-purple-600 hover:to-pink-700 text-white border-0 rounded-full group w-full sm:w-auto"
                      onClick={() => setRegisterOpen(true)}
                    >
